...
public sealed class SearchProductsQueryHandler : IQueryHandler<SearchProductsQuery, PaginationResult<ProductDto>>
{
    private readonly IDbConnectionFactory _dbConnectionFactory;

    public SearchProductsQueryHandler(IDbConnectionFactory dbConnectionFactory)
    {
    ...
    public async Task<Result<PaginationResult<ProductDto>>> Handle(SearchProductsQuery request, CancellationToken cancellationToken)
    {
        ...
        parameters["ProductStatus"] = "Active";
