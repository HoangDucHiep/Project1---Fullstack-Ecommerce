...
namespace ECommerceBackend.Infrastructure.Migrations.Application
{
    ...
    [Migration("20251022144614_AddIsCoverToProductMedia")]
    partial class AddIsCoverToProductMedia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceBackend.Domain.Products.ProductMedia", b =>
                {
                    ...
                    b.HasIndex("ProductId", "IsCover")
                        .HasDatabaseName("ix_product_medias_product_id_is_cover");

                    b.HasIndex("ProductId", "SortOrder")
                        .HasDatabaseName("ix_product_medias_product_id_sort_order");

                    b.HasIndex("ProductVariantId", "IsCover")
                        .HasDatabaseName("ix_product_medias_product_variant_id_is_cover");
            ...
            modelBuilder.Entity("ECommerceBackend.Domain.Users.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_profiles", "ecommerce-domain");
                });
            ...
            modelBuilder.Entity("ECommerceBackend.Domain.Users.UserProfile", b =>
                {
                    b.HasOne("ECommerceBackend.Domain.Users.User", null)
                        .WithOne()
                        .HasForeignKey("ECommerceBackend.Domain.Users.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
