...
const Signup = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center pt-10 min-h-screen">
      {/* stepper */}
      <div className="relative flex items-center justify-between md:w-[50%] mb-8 mx-auto">
      ...
      <div className="md:w-[480px] p-8 bg-white shadow rounded-lg">
          ...
          <>
            {!showOtp ? (
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  type="email"
                  placeholder="support@shopdev.com"
                  className="w-full p-2 border border-gray-300 outline-0 !rounded mb-1"
                  {...register("email", {
        ...
        {activeStep === 3 && (
          <div className="text-center">
            ...
            <br />
            <button
              className="w-full m-auto flex items-center justify-center gap-3 text-lg bg-[#344155] text-white py-2 rounded-lg"
